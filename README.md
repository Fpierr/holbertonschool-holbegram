...
Welcome to the final Flutter project!  
This application is built with Flutter, a high-performance cross-platform framework that allows us to develop a single mobile app for both Android and iOS using Dart.  
...
## Dependencies
- [Firebase Database Plugin for Flutter](http://pub.dev/packages/firebase_database)
